...
namespace model_uncertainty_model_uninformative_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 26, column 2 to column 45)",
...
class model_uncertainty_model_uninformative final : public model_base_crtp<model_uncertainty_model_uninformative> {
private:
  int N;
  int K;
  int C;
...
public:
  ~model_uncertainty_model_uninformative() { }
  
  inline std::string model_name() const final { return "model_uncertainty_model_uninformative"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-1-g67504470", "stancflags = "};
  }
  
  
  model_uncertainty_model_uninformative(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_uncertainty_model_uninformative_namespace::model_uncertainty_model_uninformative";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_uncertainty_model_uninformative_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      eta = in__.vector(K);
      Eigen::Matrix<local_scalar_t__, -1, 1> mu_not;
      mu_not = Eigen::Matrix<local_scalar_t__, -1, 1>(K);
      stan::math::fill(mu_not, DUMMY_VAR__);
      
      current_statement__ = 5;
      mu_not = in__.vector(K);
        ...
        "assigning variable mu_diff");
      {
        ...
        lp_accum__.add(
          normal_lpdf<propto__>(mu, add(mu_not, multiply(sigma, eta)), sigma));
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_uncertainty_model_uninformative_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
    ...
    try {
      ...
      for (int sym1__ = 1; sym1__ <= K; ++sym1__) {
        vars__.emplace_back(mu_not[(sym1__ - 1)]);}
  ...
  inline void constrained_param_names(
    ...
    for (int sym1__ = 1; sym1__ <= K; ++sym1__) {
      {
        param_names__.emplace_back(std::string() + "mu_not" + '.' + std::to_string(sym1__));
      }}
    if (emit_transformed_parameters__) {
      for (int sym1__ = 1; sym1__ <= C; ++sym1__) {
        {
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"mu\",\"type\":{\"name\":\"vector\",\"length\":" << K << "},\"block\":\"parameters\"},{\"name\":\"sigma\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"y_diff\",\"type\":{\"name\":\"array\",\"length\":" << C << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"eta\",\"type\":{\"name\":\"vector\",\"length\":" << K << "},\"block\":\"parameters\"},{\"name\":\"mu_not\",\"type\":{\"name\":\"vector\",\"length\":" << K << "},\"block\":\"parameters\"},{\"name\":\"mu_diff\",\"type\":{\"name\":\"vector\",\"length\":" << C << "},\"block\":\"transformed_parameters\"}]";
    return s__.str();
...
using stan_model = model_uncertainty_model_uninformative_namespace::model_uncertainty_model_uninformative;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_uncertainty_model_uninformative_namespace::profiles__;
}
#endif
#endif
