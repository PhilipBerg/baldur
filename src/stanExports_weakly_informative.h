...
static constexpr std::array<const char*, 52> locations_array__ =
  ...
  " (in 'string', line 41, column 2 to column 31)",
  " (in 'string', line 42, column 2 to column 57)",
  " (in 'string', line 43, column 2 to column 41)",
  ...
  " (in 'string', line 18, column 6 to column 33)",
  " (in 'string', line 17, column 19 to line 19, column 5)",
  " (in 'string', line 17, column 4 to line 19, column 5)",
  " (in 'string', line 16, column 17 to line 20, column 3)",
  " (in 'string', line 16, column 2 to line 20, column 3)",
  " (in 'string', line 22, column 4 to column 26)",
  " (in 'string', line 21, column 17 to line 23, column 3)",
  ...
  " (in 'string', line 35, column 13 to column 14)",
  " (in 'string', line 36, column 9 to column 10)"};
#include <stan_meta_header.hpp>
class model_weakly_informative final : public model_base_crtp<model_weakly_informative> {
private:
  int N;
  int K;
  int C;
...
public:
  ...
  model_weakly_informative(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_weakly_informative_namespace::model_weakly_informative";
    // suppress unused var warning
    (void) function__;
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_weakly_informative_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
        ...
        "assigning variable sigma_lfc");
      {
        ...
        lp_accum__.add(stan::math::normal_lpdf<propto__>(prior_mu_not, 0, 10));
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_weakly_informative_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"mu", "sigma", "y_diff", "eta",
                "prior_mu_not"};
    if (emit_transformed_parameters__) {
      std::vector<std::string> temp{"mu_diff", "sigma_lfc"};
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"mu\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(K) + "},\"block\":\"parameters\"},{\"name\":\"sigma\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"y_diff\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(C) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"eta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(K) + "},\"block\":\"parameters\"},{\"name\":\"prior_mu_not\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(K) + "},\"block\":\"parameters\"},{\"name\":\"mu_diff\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(C) + "},\"block\":\"transformed_parameters\"},{\"name\":\"sigma_lfc\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(C) + "},\"block\":\"transformed_parameters\"}]");
  }
...
using stan_model = model_weakly_informative_namespace::model_weakly_informative;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_weakly_informative_namespace::profiles__;
}
#endif
#endif
