...
namespace model_uncertainty_model_highly_informative_namespace {
...
class model_uncertainty_model_highly_informative final : public model_base_crtp<model_uncertainty_model_highly_informative> {
private:
  int N;
  int K;
  int C;
...
public:
  ~model_uncertainty_model_highly_informative() { }
  
  inline std::string model_name() const final { return "model_uncertainty_model_highly_informative"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-1-g67504470", "stancflags = "};
  }
  
  
  model_uncertainty_model_highly_informative(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_uncertainty_model_highly_informative_namespace::model_uncertainty_model_highly_informative";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_uncertainty_model_highly_informative_namespace::log_prob";
(void) function__;  // suppress unused var warning
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_uncertainty_model_highly_informative_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"mu\",\"type\":{\"name\":\"vector\",\"length\":" << K << "},\"block\":\"parameters\"},{\"name\":\"sigma\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"y_diff\",\"type\":{\"name\":\"array\",\"length\":" << C << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"eta\",\"type\":{\"name\":\"vector\",\"length\":" << K << "},\"block\":\"parameters\"},{\"name\":\"mu_diff\",\"type\":{\"name\":\"vector\",\"length\":" << C << "},\"block\":\"transformed_parameters\"}]";
    return s__.str();
...
using stan_model = model_uncertainty_model_highly_informative_namespace::model_uncertainty_model_highly_informative;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_uncertainty_model_highly_informative_namespace::profiles__;
}
#endif
#endif
