...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_empirical_bayes");
    reader.add_event(49, 47, "end", "model_empirical_bayes");
    return reader;
}
#include <stan_meta_header.hpp>
class model_empirical_bayes
  : public stan::model::model_base_crtp<model_empirical_bayes> {
private:
        int N;
        int K;
        int C;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            context__.validate_dims("data initialization", "mu_not", "vector_d", context__.to_vec(K));
            mu_not = Eigen::Matrix<double, Eigen::Dynamic, 1>(K);
            vals_r__ = context__.vals_r("mu_not");
            pos__ = 0;
            size_t mu_not_j_1_max__ = K;
            for (size_t j_1__ = 0; j_1__ < mu_not_j_1_max__; ++j_1__) {
                mu_not(j_1__) = vals_r__[pos__++];
            }
            ...
            stan::math::assign(n_k, stan::math::sqrt(multiply(2, n_k)));
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> sigma_mu_not(K);
            stan::math::initialize(sigma_mu_not, DUMMY_VAR__);
            stan::math::fill(sigma_mu_not, DUMMY_VAR__);
            stan::math::assign(sigma_mu_not,multiply(sigma, n_k));
            ...
            current_statement_begin__ = 36;
            size_t sigma_mu_not_j_1_max__ = K;
            for (size_t j_1__ = 0; j_1__ < sigma_mu_not_j_1_max__; ++j_1__) {
                if (stan::math::is_uninitialized(sigma_mu_not(j_1__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: sigma_mu_not" << "(" << j_1__ << ")";
                    stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable sigma_mu_not: ") + msg__.str()), current_statement_begin__, prog_reader__());
                }
            }
            current_statement_begin__ = 37;
            ...
            lp_accum__.add(normal_log<propto__>(prior_mu_not, mu_not, sigma_mu_not));
    ...
    void get_param_names(std::vector<std::string>& names__) const {
        ...
        names__.push_back("sigma_mu_not");
    ...
    void write_array(RNG& base_rng__,
        ...
        try {
            ...
            current_statement_begin__ = 36;
            validate_non_negative_index("sigma_mu_not", "K", K);
            Eigen::Matrix<double, Eigen::Dynamic, 1> sigma_mu_not(K);
            stan::math::initialize(sigma_mu_not, DUMMY_VAR__);
            stan::math::fill(sigma_mu_not, DUMMY_VAR__);
            stan::math::assign(sigma_mu_not,multiply(sigma, n_k));
            current_statement_begin__ = 37;
            ...
            if (include_tparams__) {
                ...
                size_t sigma_mu_not_j_1_max__ = K;
                for (size_t j_1__ = 0; j_1__ < sigma_mu_not_j_1_max__; ++j_1__) {
                    vars__.push_back(sigma_mu_not(j_1__));
                }
                size_t sigma_lfc_j_1_max__ = C;
                for (size_t j_1__ = 0; j_1__ < sigma_lfc_j_1_max__; ++j_1__) {
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        if (include_tparams__) {
            ...
            for (size_t j_1__ = 0; j_1__ < sigma_mu_not_j_1_max__; ++j_1__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "sigma_mu_not" << '.' << j_1__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
            size_t sigma_lfc_j_1_max__ = C;
            for (size_t j_1__ = 0; j_1__ < sigma_lfc_j_1_max__; ++j_1__) {
...
typedef model_empirical_bayes_namespace::model_empirical_bayes stan_model;
#ifndef USING_R
