...
#include "stanExports_weighted_decision.h"

RCPP_MODULE(stan_fit4weighted_decision_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_weighted_decision")
