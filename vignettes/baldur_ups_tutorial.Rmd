...
```r
colnames(ups[-1])
#>  [1] "fmol25_1"  "fmol25_2"  "fmol25_3"  "fmol25_4"  "fmol50_1"  "fmol50_2"  "fmol50_3"  "fmol50_4"  "fmol100_1"
#> [10] "fmol100_2" "fmol100_3" "fmol100_4" "mean"      "sd"
colnames(ups_design)
...
unc_gr <- estimate_uncertainty(gr, ups, 'identifier', ups_design)
```
...
gr_results <- gr %>%
  ...
  estimate_gamma_hyperparameters(ups) %>%
...
```
We can the estimate the uncertainties and hyperparameters for the data and decision model and run them as for the GR model:


```r
# Estimate uncertainty
unc_lgmr <- estimate_uncertainty(ups_lgmr, ups, 'identifier', ups_design)
