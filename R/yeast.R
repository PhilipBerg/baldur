...
#' concentration in all samples. To identify true positives one can use `stringr::str_detect(yeast$identifier, 'YEAST')`. For details see
...
#'   \item{ng50_1}{First biological replicates with true positives spiked-in from 50
#'   ng yeast cells}
#'   \item{ng50_2}{Second biological replicates with true positives spiked-in from 50
#'   ng yeast cells}
#'   \item{ng50_3}{Third biological replicates with true positives spiked-in from 50
#'   ng yeast cells}
#'   \item{ng100_1}{First biological replicates with true positives spiked-in from 100
#'   ng yeast cells}
#'   \item{ng100_2}{Second biological replicates with true positives spiked-in from 100
#'   ng yeast cells}
#'   \item{ng100_3}{Third biological replicates with true positives spiked-in from 100
#'   ng yeast cells}
#' }
